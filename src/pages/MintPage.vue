...
function revealNft() {
    // Если NFT уже открыт, сбрасываем состояние
    if (nftRevealed.value) {
        resetNft()
        return
    }

    // Анимация встряхивания перед открытием
    ...
    setTimeout(() => {
        ...
        // Отключить конфетти через 4 секунды
        setTimeout(() => {
    ...
    <div class="gift-page">
        ...
        <div class="content-wrapper">
            ...
            <div class="gift-area">
                ...
                <transition name="nft-reveal" @after-enter="nftRevealed = true">
